...
def main():
    ...
    require(re.fullmatch(r'v0\.6\.0-preview\.\d+', tag), 'Expected a 0.6.0 preview tag')
    ...
    installers = {
        'ubuntu-22.04-x11': 'simple-clipboard_0.6.0-preview1_all.deb',
        'windows-x64': 'SimpleClipboard-0.6.0-preview-windows-x64-setup.exe',
        'macos-arm64': 'SimpleClipboard-0.6.0-preview-macos-arm64.dmg',
        'macos-intel': 'SimpleClipboard-0.6.0-preview-macos-intel.dmg',
    }
    sources = {
        'windows-x64': 'SimpleClipboard-0.6.0-preview-windows-sources.zip',
        'macos-arm64': 'SimpleClipboard-0.6.0-preview-macos-arm64-sources.zip',
        'macos-intel': 'SimpleClipboard-0.6.0-preview-macos-intel-sources.zip',
    }
